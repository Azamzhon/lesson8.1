...
public class RPG_Game {
    public static void start() {
        ...
        Warrior warrior = new Warrior(230, 20);
        Tank tank = new Tank(210, 20);
        Magic magic = new Magic(260, 15);
        Medic medic = new Medic(250, 5, 100);
        Medic youngMedic = new Medic(290, 10, 50);
        Golem golem = new Golem(1000, 15);
        Thor thor = new Thor(400, 70);

        Hero[] heroes = {warrior, tank, magic, medic, youngMedic, golem, thor};
